...
set lmargin 10
set rmargin 0
set terminal postscript portrait enhanced mono dashed lw 1.0 "Helvetica" 15
...
set style line   1 lt 1 lc rgb "%(col1)s" lw 2.0
set style line 101 lt 1 lc rgb "%(col1)s" lw 2.0 dt (6,3)
set style line  11 lt 2 lc rgb "%(col1)s" lw 2.0 dt (6,3)
set style line  21 lt 4 lc rgb "%(col1)s" lw 2.0 dt (3,2)
set style line  31 lt 6 lc rgb "%(col1)s" lw 2.0 dt (2,1)
set style line  41 lt 8 lc rgb "%(col1)s" lw 2.0 dt (4,3)

set style line   2 lt 1 lc rgb "%(col2)s" lw 2.0
set style line 102 lt 1 lc rgb "%(col2)s" lw 2.0 dt (6,3)
set style line  12 lt 2 lc rgb "%(col2)s" lw 2.0 dt (6,3)
set style line  22 lt 4 lc rgb "%(col2)s" lw 2.0 dt (3,2)
set style line  32 lt 6 lc rgb "%(col2)s" lw 2.0 dt (2,1)
set style line  42 lt 8 lc rgb "%(col2)s" lw 2.0 dt (4,3)

set style line   3 lt 1 lc rgb "%(col3)s" lw 2.0
set style line 103 lt 1 lc rgb "%(col3)s" lw 2.0 dt (6,3)
set style line  13 lt 2 lc rgb "%(col3)s" lw 2.0 dt (6,3)
set style line  23 lt 4 lc rgb "%(col3)s" lw 2.0 dt (3,2)
set style line  33 lt 6 lc rgb "%(col3)s" lw 2.0 dt (2,1)
set style line  43 lt 8 lc rgb "%(col3)s" lw 2.0 dt (4,3)

set style line   4 lt 1 lc rgb "%(col4)s" lw 2.0
set style line 104 lt 1 lc rgb "%(col4)s" lw 2.0 dt (6,3)
set style line  14 lt 2 lc rgb "%(col4)s" lw 2.0 dt (6,3)
set style line  24 lt 4 lc rgb "%(col4)s" lw 2.0 dt (3,2)
set style line  34 lt 6 lc rgb "%(col4)s" lw 2.0 dt (2,1)
set style line  44 lt 8 lc rgb "%(col4)s" lw 2.0 dt (4,3)

set style line   5 lt 1 lc rgb "%(col5)s" lw 2.0
set style line 105 lt 1 lc rgb "%(col5)s" lw 2.0 dt (6,3)
set style line  15 lt 2 lc rgb "%(col5)s" lw 2.0 dt (6,3)
set style line  25 lt 4 lc rgb "%(col5)s" lw 2.0 dt (3,2)
set style line  35 lt 6 lc rgb "%(col5)s" lw 2.0 dt (2,1)
set style line  45 lt 8 lc rgb "%(col5)s" lw 2.0 dt (4,3)

set style line   6 lt 1 lc rgb "%(col6)s" lw 2.0
set style line 106 lt 1 lc rgb "%(col6)s" lw 2.0 dt (6,3)
set style line  16 lt 2 lc rgb "%(col6)s" lw 2.0 dt (6,3)
set style line  26 lt 4 lc rgb "%(col6)s" lw 2.0 dt (3,2)
set style line  36 lt 6 lc rgb "%(col6)s" lw 2.0 dt (2,1)
set style line  46 lt 8 lc rgb "%(col6)s" lw 2.0 dt (4,3)

set style line   7 lt 1 lc rgb "%(col7)s" lw 2.0
set style line 107 lt 1 lc rgb "%(col7)s" lw 2.0 dt (6,3)
set style line  17 lt 2 lc rgb "%(col7)s" lw 2.0 dt (6,3)
set style line  27 lt 4 lc rgb "%(col7)s" lw 2.0 dt (3,2)
set style line  37 lt 6 lc rgb "%(col7)s" lw 2.0 dt (2,1)
set style line  47 lt 8 lc rgb "%(col7)s" lw 2.0 dt (4,3)

set style line   8 lt 1 lc rgb "%(col8)s" lw 2.0
set style line 108 lt 1 lc rgb "%(col8)s" lw 2.0 dt (6,3)
set style line  18 lt 2 lc rgb "%(col8)s" lw 2.0 dt (6,3)
set style line  28 lt 4 lc rgb "%(col8)s" lw 2.0 dt (3,2)
set style line  38 lt 6 lc rgb "%(col8)s" lw 2.0 dt (2,1)
set style line  48 lt 8 lc rgb "%(col8)s" lw 2.0 dt (4,3)
...
set multiplot
set label "%(title)s" font ",15" at graph 0.04, graph 1.05
...
#            tit=tit+', PDF is dotted'
        replacement_dic['set_histo_label'] = \
         'set label "%s" font ",15" front at graph 0.03, graph 0.13' % tit
...
#        replacement_dic['set_ytics'] = 'set ytics %f'%((int(10*(ymax-ymin))/10)/10.0)
        ...
        replacement_dic['set_format_y'] = 'unset format'
        replacement_dic['set_histo_label'] = \
        'set label "%s" font ",15" at graph 0.03, graph 0.13'%ratio_name_long
