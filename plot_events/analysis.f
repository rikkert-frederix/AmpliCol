...
c
      ...
      call HwU_book(2,'ratio NLC/LC narrow',500,0.7d0,1.4d0)
      call HwU_book(3,'ratio full/LC narrow',500,0.7d0,1.4d0)
      call HwU_book(4,'ratio full/NLC narrow',500,0.95d0,1.05d0)

      call HwU_book(5,'ratio log10(NLC/LC) narrow',500,-0.5d0,0.5d0)
      call HwU_book(6,'ratio log10(full/LC) narrow',500,-0.5d0,0.5d0)
      call HwU_book(7,'ratio log10(full/NLC) narrow',500,-0.05d0,0.05d0)

      call HwU_book(8,'ratio NLC/LC',500,-25d0,25d0)
      call HwU_book(9,'ratio full/LC',500,-25d0,25d0)
      call HwU_book(10,'ratio full/NLC',500,-25d0,25d0)

      call HwU_book(11,'ratio log10(NLC/LC)',500,-2d0,2d0)
      call HwU_book(12,'ratio log10(full/LC)',500,-2d0,2d0)
      call HwU_book(13,'ratio log10(full/NLC)',500,-2d0,2d0)

      call HwU_book(14,'ratio log10(NLC/LC) wide',500,-6d0,6d0)
      call HwU_book(15,'ratio log10(full/LC) wide',500,-6d0,6d0)
      call HwU_book(16,'ratio log10(full/NLC) wide',500,-6d0,6d0)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     $     ,evt_wgt_full(1),www(1)
      ...
      call HwU_fill(3,evt_wgt_full(1)/evt_wgt_LC(1),www)
      call HwU_fill(4,evt_wgt_full(1)/evt_wgt_NLC(1),www)
      if (evt_wgt_NLC(1).gt.0d0) call HwU_fill(5,log10(evt_wgt_NLC(1)
     $     /evt_wgt_LC(1)),www)
      if (evt_wgt_full(1).gt.0d0) call HwU_fill(6,log10(evt_wgt_full(1)
     $     /evt_wgt_LC(1)),www)
      if (evt_wgt_full(1).gt.0d0) call HwU_fill(7,log10(evt_wgt_full(1)
     $     /evt_wgt_NLC(1)),www)
      call HwU_fill(8,evt_wgt_NLC(1)/evt_wgt_LC(1),www)
      call HwU_fill(9,evt_wgt_full(1)/evt_wgt_LC(1),www)
      call HwU_fill(10,evt_wgt_full(1)/evt_wgt_NLC(1),www)
      if (evt_wgt_NLC(1).gt.0d0) call HwU_fill(11,log10(evt_wgt_NLC(1)
     $     /evt_wgt_LC(1)),www)
      if (evt_wgt_full(1).gt.0d0) call HwU_fill(12,log10(evt_wgt_full(1)
     $     /evt_wgt_LC(1)),www)
      if (evt_wgt_full(1).gt.0d0) call HwU_fill(13,log10(evt_wgt_full(1)
     $     /evt_wgt_NLC(1)),www)
      
      if (evt_wgt_NLC(1).gt.0d0) call HwU_fill(14,log10(evt_wgt_NLC(1)
     $     /evt_wgt_LC(1)),www)
      if (evt_wgt_full(1).gt.0d0) call HwU_fill(15,log10(evt_wgt_full(1)
     $     /evt_wgt_LC(1)),www)
