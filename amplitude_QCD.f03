...
!!$      endif
    ...
    subroutine define_canonical_color_order()
      ...
      elseif (nq.eq.3) then
         ...
         do i=2,nglu
            if (color_orders_64.gt.huge(color_orders_64)/int(i,kind=8)) then
               write (*,*) 'Three-line colour basis exceeds integer range'
               stop 1
            endif
         ...
         if (color_orders_64.gt.int(huge(this%nColOrd),kind=8)) then
            write (*,*) 'Three-line colour basis exceeds supported index range',&
                 color_orders_64,huge(this%nColOrd)
            stop 1
         endif
